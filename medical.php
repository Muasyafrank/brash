      ...
      <div class="section__container header__container" id="home">
        ...
        <div class="header__form">
          <form id="appointmentForm" method="POST" action ="book_appointment.php" >
            ...
            <input type="text" name = "address"  placeholder="Reason"  id ="address" required/>
            <input type="text" name = "phone" placeholder="Phone No." id ="phoneNo"  required/>
    ...
    <footer class="footer">
      <div class="section__container footer__container">
        ...
        <div class="footer__col">
          <h4>Contact Us</h4>
          <p>
            <i class="ri-map-pin-2-fill"></i> 123, Kimathi Street, Nyeri
          </p>
          <p><i class="ri-mail-fill"></i> healthcare@gmail.com</p>
          <p><i class="ri-phone-fill"></i> (+254) 723 456 789</p>
        </div>
      </div>
